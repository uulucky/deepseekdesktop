...
exports.apply = (ctx) => {
  ctx.systemPrompt.section({
    ...
    order: 10300,
    text: `DeepSeek Desktop communication style:
Before a tool-using step, begin your ordinary assistant response (not the reasoning channel) with one short public-facing action summary in Simplified Chinese, using this exact wrapper:
